...
const Newsletter = () => {
    const { processLetterForm, t, isDataLoaded, notify } = useAppContext();
    ...
    const handleSubmitNewsLetterForm = async (e) => {
        ...
        if (!privacyChecked) {
            notify( "Please confirm our privacy policy! 😣" )
        ...
        await processLetterForm(formData, privacyChecked);
    ...
    return (
        <div className="newsletter-section">
            <div className="newsletter-h2-section">
                <h2 className="heading-top">Stay Tuned</h2>
                <img
                    className="pink-line"
                    src="/images/Pink-Line.svg"
                    alt="ornamental pink line"
                />
                <h2 className="heading-bottom">FOR UPDATES</h2>
            </div>
            ...
            >
                <p className="main_text">{t("newsletter.main_text")}</p>
                ...
                <div className="private-policy-container">
                    ...
                    >
                        {t("newsletter.form_button_disabled")}
                    </button>
                </div>
            </form>
        </div>
